...
# trojan
wget -O add-tr "https://raw.githubusercontent.com/noelrubio143/aa/refs/heads/main/xray/add-tr.sh" && chmod +x add-tr
wget -O trialtrojan "https://raw.githubusercontent.com/noelrubio143/aa/refs/heads/main/xray/trialtrojan.sh" && chmod +x trialtrojan
wget -O del-tr "https://raw.githubusercontent.com/noelrubio143/aa/refs/heads/main/xray/del-tr.sh" && chmod +x del-tr
