...
wget https://raw.githubusercontent.com/noelrubio143/aa/refs/heads/main/udp-custom/slowdns/slowdns1.sh && chmod +x slowdns1.sh && ./slowdns1.sh
sleep 1
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/noelrubio143/aa/refs/heads/main/udp-custom/udp-custom-linux-amd64" -O /root/udp/udp-custom && rm -rf /tmp/cookies.txt
...
sleep 1
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/noelrubio143/aa/refs/heads/main/udp-custom/config.json" -O /root/udp/config.json && rm -rf /tmp/cookies.txt
