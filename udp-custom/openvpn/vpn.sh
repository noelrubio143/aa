...
cat > /etc/openvpn/client-tcp-443.ovpn <<-END
...
sed -i $MYIP2 /etc/openvpn/client-tcp-443.ovpn;
...
echo '<ca>' >> /etc/openvpn/client-tcp-443.ovpn
...
cp /etc/openvpn/client-tcp-443.ovpn /home/vps/public_html/client-tcp-443.ovpn
